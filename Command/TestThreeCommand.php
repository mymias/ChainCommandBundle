 ...
 */
class TestThreeCommand extends Command
{
    protected function configure()
    {
        $this
            ->setName('oro.chain_bundle.test_command.three')
        ;
    }
    ...
    {
        $output->writeln(sprintf('Hi again! How ara you doin\'? This is command %s', $this->getName()));
    }
}